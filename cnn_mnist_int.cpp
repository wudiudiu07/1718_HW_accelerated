...
/* ************************************************************ */
/* Helper functions */
int convolution(int a, int b, unsigned char img[], int offset_img_a, int offset_img_b, int weights[5]) {
  int result = 0;
  for (int i = 0; i < a; i++) {
    for (int j = 0; j < b; j++) {
      result += img[(i + offset_img_a) * 32 + j + offset_img_b] * weights[i * b + j];
    }
  }
  return result;
}
...
/* ************************************************************ */
/* Backward Pass */
void backward_pass(double *y_hat, int *y, unsigned char img[1120]) {
  double delta4[10];
  for (int i = 0; i < 10; i++) {
...
void give_img(unsigned char *vec, unsigned char img[1120]) {
  int k = 0;
  for (int i = 0; i < 35; i++) {
    for (int j = 0; j < 32; j++) {
